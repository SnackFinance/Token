...
/**
  ...
  features. Users can borrow for peer-to-peer farms or take out a Snack Finance loan.
...
contract SnackFinance is Context, IERC20, Ownable {
    ...
    string private _name = "Snack Finance";
    string private _symbol = "SNCK";
    ...
    address public charityWallet = 0x03202AFD389c0A05633C4b28b6E4Fb0A790f02AB;
    ...
    uint256 public numTokensSellToAddToLiquidity = 2400000 * 10**9;
    uint256 public _maxTxAmount = 240000000 * 10**9;
